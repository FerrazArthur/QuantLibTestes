...
void precificar(Titulo titulo, Volatility volatility, int imprimir)
{
    /*
...
{
    /*
     * Código para realizar os calculos para os dados no arquivo csv enviado pelo processo seletivo, com diferentes valores para volatilidade.
     */
    try
    {
